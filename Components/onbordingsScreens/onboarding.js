...
const SplashScreen0 = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      navigation.replace('SplashScreen1'); // Replace with the actual name of your main screen
    }, delay);
  ...
  const handleSkip = () => {
    ...
    navigation.replace('SignIn'); // Replace with the actual name of your main screen
  };
